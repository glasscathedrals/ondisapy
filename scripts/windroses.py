...
class WindroseAxes(PolarAxes):
    ...
    def __init__(self, *args, **kwargs):
        """
        See axesbase class for args and kwargs documentation
        """
    ...
    def cla(self):
        ...
        self.theta_labels = ['E', 'NE', 'N', 'NW', 'W', 'SW', 'S', 'SE']
    ...
    def legend(self, loc="lower left", decimal_places=1, **kwargs):
        ...
        def get_labels(decimal_places=1):
            ...
            fmt = "%." + _decimal_places + "f" +" ≤ U ≤ %0." + _decimal_places + "f"
